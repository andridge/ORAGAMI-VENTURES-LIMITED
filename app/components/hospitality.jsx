    ...
    return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-bold tracking-tight text-red-600 sm:text-4xl">HOSPITALITY</h2>
          <p className="mt-6 text-lg leading-8 text-black">
          We encompass travel and catering
          </p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            Offering exclusive benefits, discounts, and personalized experiences, enhancing both leisure and event-related services for members
            </p>
