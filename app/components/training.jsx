    ...
    return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-bold tracking-tight text-red-600 sm:text-4xl">TRAINING</h2>
          <p className="mt-6 text-lg leading-8 text-black">
          We offer programs tailored to specific needs.
          </p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            Offering access to specialized courses and resources for skill development, enabling professionals to excel in service-related industries through continuous learning and expertise enhancement.
            </p>
